...
#define EXYNOS5_SPI_MAX_FREQUENCY		50000000
#define EXYNOS5_SPI_NUM_CONTROLLERS  2

#define CONFIG_CMD_NET
#define CONFIG_CMD_DHCP
#define CONFIG_DRIVER_AX88796C_SPI	1
#define AX88796C_SPI_BUS		0
#define AX88796C_SPI_CS			0
#define AX88796C_MAX_HZ			40000000
#define AX88796C_SPI_MODE		0
